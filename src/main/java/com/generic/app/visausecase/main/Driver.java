...
public class Driver {
	...
	public static void main(String args[]) throws InterruptedException,
		...
		if (args.length < 3) {
			...
			operation = args[1];
			partitioncount = Integer.parseInt(args[2]);
			readVisaData(serverNames, partitioncount);

		}
	}

	
	private static void readVisaData(String serverNames2, int partitioncount2) {
		...
		String str = new Date().toString() + " " + " To process " + i
